...
# Sample lines from real ESTV files (ZH 2026)
SAMPLE_LINE_06 = "0601ZHA0N       20260101000000100000080000 000000000000000025   "
SAMPLE_LINE_HEADER = "0101ZH                                                        "
SAMPLE_LINE_HIGH_INCOME = "0601ZHB2Y       20260101000500100000005000 020000000000001250   "
...
class TestParseLine(unittest.TestCase):
	...
	def test_tax_amount_rappen_conversion(self):
		...
		line = "0601ZHA0N       20260101000000100000080000 000000001234500025   "
...
class TestParseFile(unittest.TestCase):
	...
	def test_canton_filter(self):
		...
		line_ge = "0601GEA0N       20260101000000100000244995 000000000000000000   "
		content = f"{SAMPLE_LINE_06}\n{line_ge}"
