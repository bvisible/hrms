#//// Neoffice — added file (no upstream equivalent): pre-export validation of the ELM declaration
#//// (employee, company and salary completeness) — the transmitter rejects late.
