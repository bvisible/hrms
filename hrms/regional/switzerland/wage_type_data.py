...
def get_swiss_wage_types():
	...
	return [
		...
		_wt(
			...
			common=1,
			abbr="OTP",
			desc_fr="Heures supplémentaires",
		),
		...
		_wt(1165, "Paiement vacances", "Earning", "1", _ALL, vac=0, stat="HS", payment_days=0),
		# //// Neoffice — 2026-09-24: vacation paid after the exit (Swissdec 6.0 model "1168"): box 3
		# //// of the certificate, aperiodic for the source tax (annex 1 cases M33, M35, M36).
		_wt(
			1168,
			"Paiement vacances après le départ",
			"Earning",
			"3",
		...
		_wt(
			...
			common=1,
			abbr="13M",
			desc_fr="Treizième salaire — Calculé automatiquement par le module suisse",
			payment_days=0,
		),
		...
		# //// Neoffice — 2026-09-24: the 14th and 15th salaries (extra_salaries.py). 1205 is the
		# //// Swissdec model's "14. Monatslohn", with the flags of 1200; 1206 follows it for a 15th.
		# //// Both on box 1 of the certificate when contractual (guide 2026, Cm 27).
		_wt(
			1205,
			"14e salaire",
			"Earning",
			...
			stat="SMS",
			abbr="14M",
			desc_fr="Quatorzième salaire — Calculé automatiquement par le module suisse",
			payment_days=0,
		),
		_wt(
			1206,
			...
			stat="SMS",
			abbr="15M",
			desc_fr="Quinzième salaire — Calculé automatiquement par le module suisse",
			payment_days=0,
		),
		# =====================================================================
		...
		_wt(
			...
			common=1,
			abbr="CHAP",
			desc_fr="Indemnité APG (allocation perte de gain)",
			payment_days=0,
		),
		_wt(
			2005,
		...
		_wt(
			...
			common=1,
			abbr="IIJM",
			desc_fr="Indemnité journalière maladie IJM",
			payment_days=0,
		),
		_wt(
			2040,
			...
			common=1,
			abbr="MATA",
			desc_fr="Allocation de maternité",
			payment_days=0,
		),
		...
		_wt(
			2065,
			"Perte de gain RHT/ITP (SH)",
			"Earning",
			"",
			{"avs": 1, "ac": 1, "laa": 1, "ijm": 1, "lpp": 1, "imp": 0},
			stat="",
			bases_only=1,
		),
		...
		_wt(
			...
			common=1,
			abbr="CHALL",
			desc_fr="Allocation pour enfant",
			payment_days=0,
		),
		_wt(
			3010,
		...
		_wt(
			5022,
			"Cotisation AC solidarité employé",
			"Deduction",
			"9",
			_DEDUCTION,
			stat="CS",
		...
		_wt(
			5023,
			"Cotisation AC solidarité employeur",
			"Deduction",
			"9",
			_DEDUCTION,
			stat="CS",
		...
		_wt(
			5024,
			"Cotisation allocations familiales employeur",
			"Deduction",
			"9",
			_DEDUCTION,
			stat="CS",
		...
		_wt(
			5056,
			"Cotisations rachat LPP",
			"Deduction",
			"10.2",
			_DEDUCTION,
			stat="CS",
			desc_fr="Rachat LPP (prévoyance professionnelle)",
		),
		# =====================================================================
		...
		_wt(
			...
			common=1,
			abbr="TVLE",
			desc_fr="Remboursement frais de voyage",
			payment_days=0,
		),
		_wt(
			6001,
			...
			common=1,
			abbr="CARE",
			desc_fr="Remboursement frais de voiture",
			payment_days=0,
		),
		_wt(
			6002,
			...
			common=1,
			abbr="MEAL",
			desc_fr="Remboursement frais de repas",
			payment_days=0,
		),
		...
		_wt(
			...
			common=1,
			abbr="REPR",
			desc_fr="Frais forfaitaires de représentation",
			payment_days=0,
		),
		# //// Neoffice — 2026-09-24: a flat-rate allowance follows the company's expense regulation
		# //// (expenses.py: entry or exit month, reduction beyond four weeks of absence), never the
		# //// days paid — those cut it from the first unpaid day, and 6040 was already exempt of them.
		# //// 6060 was subject to every insurance: Swissdec 6.0 (ch. 5, wage type table) has all its
		# //// columns at 0, like every expense of 6000-6070.
		_wt(6050, "Frais forfaitaires de voiture", "Earning", "13.2.2", _EXEMPT, stat="", payment_days=0),
		_wt(6060, "Frais forfaitaires pour expatriés", "Earning", "2.3", _EXEMPT, stat="", payment_days=0),
		_wt(6070, "Autres frais forfaitaires", "Earning", "13.2.3", _EXEMPT, stat="", payment_days=0),
		# =====================================================================
